...
public class NbtUtil_v1_14_R1 extends NbtUtil {
    ...
    public ItemWrapper getItemTagWrapper(ItemStack itemStack, Object nmsItem) {
        return new ItemWrapperImpl(itemStack, (net.minecraft.server.v1_14_R1.ItemStack) nmsItem);
    }
    ...
    @Override
    public net.minecraft.server.v1_14_R1.ItemStack getNMSItem(ItemStack itemStack) {
        return CraftItemStack.asNMSCopy(itemStack);
    }

    @Override
    public void setNMSItem(ItemStack itemStack, Object nmsItem) {
        itemStack.setItemMeta(CraftItemStack.getItemMeta((net.minecraft.server.v1_14_R1.ItemStack) nmsItem));
    }

    @Override
    public NBTTagCompound getNMSItemNBT(Object nmsItem) {
        return ((net.minecraft.server.v1_14_R1.ItemStack) nmsItem).getTag();
    }
    ...
    public final class ItemWrapperImpl extends WrapperImpl implements ItemWrapper {
        ...
        final net.minecraft.server.v1_14_R1.ItemStack nmsItem;
        ...
        ItemWrapperImpl(ItemStack itemStack, net.minecraft.server.v1_14_R1.ItemStack nmsItem) {
    ...
    public class WrapperImpl implements Wrapper {
        ...
        public void save(ItemStack itemStack) {
            net.minecraft.server.v1_14_R1.ItemStack nmsItem = getNMSItem(itemStack);
