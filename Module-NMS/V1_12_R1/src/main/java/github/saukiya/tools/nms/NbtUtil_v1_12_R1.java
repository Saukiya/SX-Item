...
public class NbtUtil_v1_12_R1 extends NbtUtil {
    ...
    public ItemWrapper getItemTagWrapper(ItemStack itemStack, Object nmsItem) {
        return new ItemWrapperImpl(itemStack, (net.minecraft.server.v1_12_R1.ItemStack) nmsItem);
    }
    ...
    @Override
    public net.minecraft.server.v1_12_R1.ItemStack getNMSItem(ItemStack itemStack) {
        return CraftItemStack.asNMSCopy(itemStack);
    }

    @Override
    public void setNMSItem(ItemStack itemStack, Object nmsItem) {
        itemStack.setItemMeta(CraftItemStack.getItemMeta((net.minecraft.server.v1_12_R1.ItemStack) nmsItem));
    }

    @Override
    public NBTTagCompound getNMSItemNBT(Object nmsItem) {
        return ((net.minecraft.server.v1_12_R1.ItemStack) nmsItem).getTag();
    }
        ...
        if (nbtBase instanceof NBTBase) {
            switch (((NBTBase) nbtBase).getTypeId()) {
                ...
                case 9:
                    ...
                    return IntStream.range(0, nbtTagList.size()).mapToObj(i -> getNMSValue(nbtTagList.i(i))).collect(Collectors.toList());
                case 7:
    ...
    public final class ItemWrapperImpl extends WrapperImpl implements ItemWrapper {
        ...
        ItemWrapperImpl(ItemStack itemStack, net.minecraft.server.v1_12_R1.ItemStack nmsItem) {
    ...
    public class WrapperImpl implements Wrapper {
        ...
        public void save(ItemStack itemStack) {
            net.minecraft.server.v1_12_R1.ItemStack nmsItem = getNMSItem(itemStack);
