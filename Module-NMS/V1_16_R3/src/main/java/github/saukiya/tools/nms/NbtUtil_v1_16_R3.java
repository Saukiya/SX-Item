...
public class NbtUtil_v1_16_R3 extends NbtUtil {
    ...
    public ItemWrapper getItemTagWrapper(ItemStack itemStack, Object nmsItem) {
        return new ItemWrapperImpl(itemStack, (net.minecraft.server.v1_16_R3.ItemStack) nmsItem);
    }
    ...
    public final class ItemWrapperImpl extends WrapperImpl implements ItemWrapper {
        ...
        ItemWrapperImpl(ItemStack itemStack, net.minecraft.server.v1_16_R3.ItemStack nmsItem) {
