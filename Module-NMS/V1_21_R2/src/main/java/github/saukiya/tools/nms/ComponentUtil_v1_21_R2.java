...
public class ComponentUtil_v1_21_R2 extends ComponentUtil {
    ...
    public DataComponentPatch getDataComponentPatch(Object nmsItem) {
        return ((net.minecraft.world.item.ItemStack) nmsItem).e();
    }
    ...
    public void setComponentMapValue(Object dataComponentMap, String type, Object value) {
        DataComponentType dataComponentType = BuiltInRegistries.ao.a(MinecraftKey.c(type));
    ...
    public List<String> getItemKeys() {
        return BuiltInRegistries.ao.i().stream().map(MinecraftKey::toString).toList();
    }
}
