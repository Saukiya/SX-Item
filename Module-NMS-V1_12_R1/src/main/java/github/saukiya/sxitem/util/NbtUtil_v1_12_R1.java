    ...
    public TagBase asTagCopy(Object nbtBase) {
        ...
        if (nbtBase instanceof NBTBase) {
            if (nbtBase instanceof NBTTagCompound) {
                ...
                tagBase = IntStream.range(0, nbtTagList.size()).mapToObj(i -> asTagCopy(nbtTagList.i(i))).collect(Collectors.toCollection(TagList::new));
                ...
                tagBase = new TagLongArray((long[]) NMS.getPrivateField(nbtBase, "b"));
