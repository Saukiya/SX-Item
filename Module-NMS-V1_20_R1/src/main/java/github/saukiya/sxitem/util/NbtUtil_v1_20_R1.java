...
public class NbtUtil_v1_20_R1 extends NbtUtil {
    ...
    public NBTTagCompound getNMSItemNBT(Object nmsItem) {
        return ((net.minecraft.world.item.ItemStack) nmsItem).v();
    }
    ...
    public Object getNMSValue(Object nbtBase) {
        if (nbtBase instanceof NBTBase) {
            switch (((NBTBase) nbtBase).c().b()) {
                ...
                case "TAG_String":
                    return ((NBTTagString) nbtBase).m_();
                case "TAG_Byte":
    ...
    public class NBTWrapperImpl implements NBTWrapper {
        ...
        private NBTWrapperImpl(NBTTagCompound tagCompound) {
